...
- [ ] T054 [P] Add the `create --yes` removal to the commit body as a `BREAKING CHANGE:` trailer so release-please surfaces it in the changelog, using the wording in `contracts/cli-surface-delta.md` §6
